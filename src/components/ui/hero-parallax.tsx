      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-16">
        ...
        {profile && (
          <motion.div
            ...
            className="glass rounded-2xl p-6 md:p-8 max-w-sm w-full lg:w-auto shrink-0"
          >
            {/* Avatar */}
            <motion.div
            ...
            {profile.socials && (
              ...
              >
                ...
                {profile.socials.twitter && (
                  <a href={profile.socials.twitter} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-secondary/50 hover:bg-primary/20 hover:text-primary transition-all duration-300">
